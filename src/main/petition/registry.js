...
const FORMS = [
  ...
  { code: 'B106C',    order: 5,  label: 'Schedule C — Property You Claim as Exempt',   pages: 2,  mapper: 'B106C',    required: true,  chapter: 'all' },
  { code: 'B106D',    order: 6,  label: 'Schedule D — Creditors With Secured Claims',  pages: 3,  mapper: 'B106D',    required: true,  chapter: 'all' },
  { code: 'B106EF',   order: 7,  label: 'Schedule E/F — Unsecured Claims',             pages: 6,  mapper: 'B106EF',   required: true,  chapter: 'all' },
  { code: 'B106G',    order: 8,  label: 'Schedule G — Executory Contracts and Leases', pages: 2,  mapper: 'B106G',    required: true,  chapter: 'all' },
  { code: 'B106H',    order: 9,  label: 'Schedule H — Codebtors',                      pages: 2,  mapper: 'B106H',    required: true,  chapter: 'all' },
  ...
  { code: 'B107',     order: 13, label: 'Statement of Financial Affairs',              pages: 12, mapper: 'B107',     required: true,  chapter: 'all' },
  { code: 'B108',     order: 14, label: 'Statement of Intention',                      pages: 2,  mapper: null,        required: true,  chapter: 7,     headerOnly: true },
  { code: 'B122A-1',  order: 15, label: 'Chapter 7 Statement of Current Monthly Income', pages: 2, mapper: 'B122A-1',  required: true,  chapter: 7 },
  { code: 'B122A-2',  order: 16, label: 'Chapter 7 Means Test Calculation',            pages: 9,  mapper: 'B122A-2',  required: true,  chapter: 7 },
];
